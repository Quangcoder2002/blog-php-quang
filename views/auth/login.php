...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="publics/Admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="?admin=admin&mod=auth&act=login" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" class="btn btn-primary centre" >Đăng nhập</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
